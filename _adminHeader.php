            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        <p id="RolUsuarioLogin">Administrador</p>
                    </div>
                </div>
                <!-- sidebar menu: : style can be found in sidebar.less -->
                <ul class="sidebar-menu" data-widget="tree">
                    <li class="headline">
                        <a href="/adminGesUsuario.php">
                            <i class="fa fa-users"></i>
                            <span>Gestión de Usuarios</span>
                        </a>
                    </li>
                    <li class="headline">
                        <a href="/adminEvento.php">
                            <i class="fa fa-calendar"></i>
                            <span>Gestión de Eventos</span>
                        </a>
                    </li>
                    <li class="headline">
                        <a href="/adminPonente.php">
                            <i class="fa fa-user"></i>
                            <span>Gestión de Ponentes</span>
                        </a>
                    </li>
                    <li class="headline">
                        <a href="/adminGesRegistro">
                            <i class="fa fa-pencil-square"></i>
                            <span>Gestión de Registros</span>
                        </a>
                    </li>
                    <li class="headline">
                        <a href="/adminCategoriaEvento.php">
                            <i class="fa fa-pencil-square"></i>
